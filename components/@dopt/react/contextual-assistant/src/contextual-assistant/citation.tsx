...
function ContextualAssistantCitation(props: CitationProps) {
  const {
    theme: injectedTheme,
    className,
    style,
    ...
    return (
      <a
        className={clsx(
          themeClassName({
            theme,
            className: classes.contextualAssistantCitationLink,
          }),
      ...
      >
        <cite
          className={clsx(
            themeClassName({
              theme,
              className: classes.contextualAssistantCitation,
            }),
            citationClassName,
...
const Citation = ContextualAssistantCitation;
